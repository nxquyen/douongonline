...
$id = $_GET['id'];
$row_sp= $tintuc->detailSanPham($id);
if(isset($_POST['btnSua'])==true){ 	
	...
	if($flag){
		$tintuc->editSanPham($id,$iddanhmuc,$tensanpham,$name_link,$filename,$mota,$gia,$soluongnhap,$soluongnhap,$user_login,$edit_time,$daycreate,$active,$user_login,$view);
		echo '<script type="text/javascript">alert("Sửa thành công!");window.location ="main.php?act=qlsanpham.html"; </script>';
	}else{
    ...
    require_once('../views/qlsanpham/suasanpham.php');
}
