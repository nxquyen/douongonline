...
require_once("../../../main/class/function.php");
require_once("../../../main/models/Account.php");
...
if(isset($_POST['btdn'])){
	...
	if ($acount->checkAccount($username,$password)) {
		...
		echo '<script type="text/javascript">alert("Đăng nhập thành công!");window.location="../../../"; </script>';
		exit;
		}
	}else{
...
require_once("../../../main/views/main.php");
unset($acount);
